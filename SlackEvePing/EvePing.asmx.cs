...
namespace SlackEvePingWebservice {
	...
	public class EvePing : WebService {
		/// <summary>
		///     Send a eve Ping
		/// </summary>
		...
		/// <returns></returns>
		[WebMethod]
		public string SendPing( string token, string team_id, string channel_id, string channel_name, string user_id,
								string user_name, string command, string text ) {
